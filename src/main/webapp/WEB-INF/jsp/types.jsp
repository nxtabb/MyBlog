...
<nav class="ui inverted attached segment m-padded-tb-mini m-shadow-small" >
    ...
    <div class="ui container">
        ...
        <div class="ui inverted secondary stackable menu">
            ...
            <!--菜单栏-->
            <a href="<%=path%>/plt" class="m-item item m-mobile-hide" ><i class="home icon"></i>首页</a>
    ...
    <div class="ui container">
        ...
        <div class="ui attached segment m-padded-tb-large">
            ...
            <div class="ui labeled button m-margin-tb-tiny">
                <a href="<%=path%>/types/${typeCount.typeId}/1" class="ui basic teal button">
                    ${typeCount.typeName}
                </a>
                <div class="ui basic teal left pointing label">${typeCount.count}</div>
            </div>
            </c:forEach>
        </div>
        <!--分类下面的博客列表-->
...
<script>
    ...
    $("#nextPage").click(function () {
        window.location.href='<%=path%>/types/${currenttypeId}/${nextPage}'
    });
